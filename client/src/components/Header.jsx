  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <input placeholder="Search for blogs" required="" class="w-full pl-4 outline-none" type="text"/>
        <button type="submit" class="bg-primary text-white px-8 py-2 m-1.5 rounded hover:scale-105 transition-all cursor-pointer">
        Search
        </button>
        </form>
      </div>
